...
import pl.lunarhost.lunarcashout.command.BanknotesCommand;
import pl.lunarhost.lunarcashout.command.DepositCommand;
import pl.lunarhost.lunarcashout.command.WithdrawCommand;
 ...
 */
public class LunarCashOutPlugin extends JavaPlugin {
        ...
        getServer().getScheduler().runTask(this, new Runnable() {
            ...
            public void run() {
                ...
                if (provider == null) {
                    ...
                    getServer().getPluginManager().disablePlugin(LunarCashOutPlugin.this);
                } else {
